...
$ git clone https://github.com/talyssonlima/dashgo.git
```
...
Este projeto está licenciado sob a Licença MIT. Veja o arquivo de [LICENÇA](https://github.com/talyssonlima/dashgo/blob/main/LICENSE) para detalhes.
